...
func TestDropbox_Validate(t *testing.T) {
	b := Dropbox{
...
func TestDropbox_Save(t *testing.T) {
	b := Dropbox{
		Endpoint: proto_datasource.Endpoint{
			Url: globals.Mock,
		},
...
func TestDropbox_Delete(t *testing.T) {
	b := Dropbox{
		Endpoint: proto_datasource.Endpoint{
			Url: globals.Mock,
		},
...
func TestDropbox_CreateIndexWithAlias(t *testing.T) {
	b := Dropbox{
		Endpoint: proto_datasource.Endpoint{
			Url: globals.Mock,
		},
