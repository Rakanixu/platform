...
ipcMain.on("starting", (event, arg) => {
  ...
  api = startService(resourcesPath + "/bin/" + process.platform + "/" + archConvert(process.arch) + "/micro.exe",["--registry=mdns", "api"] )
  web = startService(resourcesPath + "/bin/" + process.platform + "/" + archConvert(process.arch) + "/micro.exe",["--registry=mdns", "web"] )
  desktop = startService(resourcesPath + "/bin/" + process.platform + "/" + archConvert(process.arch) + "/kazoup-desktop.exe",["--registry=mdns"] )
  desktop_web = startService(resourcesPath + "/bin/" + process.platform + "/" + archConvert(process.arch) + "/kazoup-web.exe",["--registry=mdns"] )
  } else{
