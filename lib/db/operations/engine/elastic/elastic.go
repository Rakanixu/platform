...
func (e *elastic) SearchById(ctx context.Context, req *proto_operations.SearchByIdRequest) (*proto_operations.SearchByIdResponse, error) {
	var uID string
	var err error
	...
	if err != nil {
		return &proto_operations.SearchByIdResponse{}, err
	}
	...
	v := out.Hits.Hits
	// hmmm hacky FIXME
	if out.Hits.TotalHits != 1 {
		return &proto_operations.SearchByIdResponse{
			Result: `{}`,
		}, nil
	}
