...
func (a *AnnounceSentimentAnalyzer) OnAudioEnrich(ctx context.Context, msg *announce_msg.AnnounceMessage) error {
	...
	if globals.AudioEnrichTopic == msg.Handler {
		...
		if err := a.Client.Publish(ctx, a.Client.NewPublication(globals.SentimentEnrichTopic, e)); err != nil {
			return err
		}
	}
...
func (a *AnnounceSentimentAnalyzer) OnDocEnrich(ctx context.Context, msg *announce_msg.AnnounceMessage) error {
