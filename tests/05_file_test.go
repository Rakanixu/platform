...
var create_file_tests_data = testTable{
	{[]byte(`{
		...
		"method":"File.Create",
		"request":{
			"datasource_id":"` + globals.GetMD5Hash(DROPBOX_URL+USER_NAME) + `",
			"mime_type":"document",
			"file_name":"test"
		}
	}`), &http.Response{StatusCode: 200}, noDuration},
	{[]byte(`{
		...
		"method":"File.Create",
		"request":{
			"datasource_id":"` + globals.GetMD5Hash(GOOGLE_DRIVE_URL+USER_NAME) + `",
			"mime_type":"document",
			"file_name":"test"
		}
	}`), &http.Response{StatusCode: 200}, noDuration},
	{[]byte(`{
		...
		"method":"File.Create",
		"request":{
			"datasource_id":"` + globals.GetMD5Hash(ONE_DRIVE_URL+USER_NAME) + `",
			"mime_type":"document",
			"file_name":"test"
		}
	}`), &http.Response{StatusCode: 200}, noDuration},
...
var ds_delete_tests_data = testTable{
	...
	{[]byte(`{
		...
		"request": {
			"id": "` + globals.GetMD5Hash(DROPBOX_URL+USER_NAME) + `"
		}
	}`), &http.Response{StatusCode: 200}, noDuration},
	// GoogleDrive
	{[]byte(`{
		...
		"method": "DataSource.Delete",
		"request": {
			"id": "` + globals.GetMD5Hash(GOOGLE_DRIVE_URL+USER_NAME) + `"
		}
	}`), &http.Response{StatusCode: 200}, noDuration},
	// Onedrive
	{[]byte(`{
		...
		"method": "DataSource.Delete",
		"request": {
			"id": "` + globals.GetMD5Hash(ONE_DRIVE_URL+USER_NAME) + `"
		}
	}`), &http.Response{StatusCode: 200}, noDuration},
}
